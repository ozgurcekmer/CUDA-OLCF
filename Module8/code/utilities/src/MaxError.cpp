...
template <typename T>
void MaxError<T>::maxError(const Vector::managedVector<T>& v1, const Vector::managedVector<T>& v2) const
{
    T maximumError = 0.0;
    try
    {
...
template <typename T>
void MaxError<T>::maxError(const Vector::pinnedVector<T>& v1, const Vector::pinnedVector<T>& v2) const
{
    T maximumError = 0.0;
    try
    {
...
template void MaxError<float>::maxError(const Vector::managedVector<float>& v1, const Vector::managedVector<float>& v2) const;
template void MaxError<double>::maxError(const Vector::managedVector<double>& v1, const Vector::managedVector<double>& v2) const;
template void MaxError<int>::maxError(const Vector::managedVector<int>& v1, const Vector::managedVector<int>& v2) const;
template void MaxError<float>::maxError(const Vector::pinnedVector<float>& v1, const Vector::pinnedVector<float>& v2) const;
template void MaxError<double>::maxError(const Vector::pinnedVector<double>& v1, const Vector::pinnedVector<double>& v2) const;
template void MaxError<int>::maxError(const Vector::pinnedVector<int>& v1, const Vector::pinnedVector<int>& v2) const;
